...
Cases selected for this study was somewhat constrained by circumstances
and opportunity, at least for those that were visited in person. The
logisitics of and avaiable time for travel, unfortunately, limited case
selection to those that were close to the researchers' home base in
Ireland or that could otherwise be visited as part of other travel.
Hence, most of the visited sites were in the south of England, including
in the vicinity of London, Oxford, Birmingham and Bristol. However, and
in line with the recommendations of the methodological literature, the
cases selected for site visits include those that are leading and
...
\caption{ROBUST hub locations. Source: authors based on Open Street Maps (OSM). OSM data and graphics copyright OSM contributors.}\label{fig:location_map_london}
\end{figure}
...
\caption{Bristol hubs, selected images. Source: authors.}\label{fig:location_map_bristol_images}
\end{figure}
